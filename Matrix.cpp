...
void TranslationMatrix::SetTranslation(float x, float y, float z)
{
    mat[12] = x;
    mat[13] = y;
    mat[14] = z;
...
/*
*   Operator overloading for Translation Matrix
*/

TranslationMatrix TranslationMatrix::operator*(const Matrix& other)
{
