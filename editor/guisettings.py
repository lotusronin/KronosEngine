...
class SettingsGui:
	...
	def __init__(self, widget):
		...
		self.settingslabelmusic = Gtk.Label("Music: ")
		self.settingsvbox.add(self.settingslabelname)
		self.settingsvbox.add(self.settingsname)
		self.settingsvbox.add(self.settingslabelmusic)
		self.settingsvbox.add(self.settingsmusic)
